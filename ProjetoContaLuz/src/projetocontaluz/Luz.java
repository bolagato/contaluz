       ...
       switch (this.corBandeira)  {
           ...
           case "verde":
            ...
            case "amarela":
               ...
               double a = (this.difLeitura * 0.013) + this.icms;
               this.total = this.valorParcial + a;                
                break;
            case "vermelha 1":
               this.icms = (this.difLeitura * 0.042) * 0.25; 
               double b = (this.difLeitura * 0.042) + this.icms;
               this.total = b + this.valorParcial;
                break;
            case "vermelha 2":
               this.icms = (this.difLeitura * 0.062) * 0.25; 
               double c = (this.difLeitura * 0.062) + this.icms;
               this.total = this.valorParcial + c;
                break;
       }
       return this.total;
    }
